<template>
  ...
  <dialog open>
    ...
    <p>Asset Acquisition & Management, LLC ("Website"), which includes all products and services offered by Asset Acquisition & Management, LLC,
      is and remains the sole property of the Company. All rights are reserved in and for the Company Asset Acquisition & Management, LLC
      group is the owner of all the intellectual property rights, including trade names, trademarks, logos
      and the trade names in and are exclusive to Asset Acquisition & Management, LLC at all times. Except where expressly stated
      ...
      any materials or media from the Website, without obtaining prior written permission from Asset Acquisition & Management, LLC
      Group.</p>
    </div>
    <div>
      <h4>Data</h4>
    ...
    <div>
      <h4>Amendments</h4>
      <p>Asset Acquisition & Management, LLC has the right to amend the Agreement without obtaining any prior consent from the Client.
